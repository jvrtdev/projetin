 ...
 return (
   ...
   <header className="bg-white flex items-center m-4 justify-around p-2">
     ...
     <div className="flex items-center space-x-5 m-5">
       <Link to=""  className="hover:scale-105 transition-transform duration-300 ease-in-out transform origin-center" >
         <FaHome className="text-2xl ml-2"  />
         <span className="text-sm">Home</span>
       </Link>
       <Link to=""  className="mr-2 hover:scale-105 transition-transform duration-300 ease-in-out transform origin-center" >
